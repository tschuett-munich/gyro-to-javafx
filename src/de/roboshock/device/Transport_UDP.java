...
public class Transport_UDP {
	...
	private void sleep(int i) {
		try { Thread.sleep(i); } catch (Exception e) {e.printStackTrace();}
	}
	
    /**
     * If the robot values are sent in a verbose form (e.g. " P12=314") or not (e.g. " 314")
     */
	...
	public void openSocket() {
		try {
			...
			System.out.println("Can not open receiving UDP port (localhost:"+portSelf+"): "+e.getMessage());
	...
	public boolean isLineAvailable() throws IOException, Exception {
		...
		fillBufferFromSocket_timeout_1ms(); // takes time (timeout !) in the UDP version
	...
	public String readLineFromBuffer_nonBlocking() throws IOException, Exception {
	 ...
	 */
	private void fillBufferFromSocket_timeout_1ms() throws IOException, Exception {
	...
	private void convertToString(byte[] receiveData, int len) throws IOException {
